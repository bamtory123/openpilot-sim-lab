...
Before submission, run the snapshot-only verifier from a clean sim-lab checkout. It verifies only committed public material and intentionally does not require ignored local run artifacts:
