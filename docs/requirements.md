...
| REQ-ENV-002 | A frozen historical baseline is integrity-audited separately from a current-host compatibility check; any required-artifact gap remains an evidence gap and the latter cannot replace the former. | planned |
