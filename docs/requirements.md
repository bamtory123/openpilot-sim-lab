...
| REQ-ENV-002 | A frozen historical baseline is integrity-audited separately from a current-host compatibility check; the latter cannot replace the former. | planned |
