...
| REQ-ENV-002 | A frozen historical baseline is integrity-audited separately from two consecutive current-host confirmation runs; any required-artifact gap remains an evidence gap and confirmation cannot replace the baseline. | planned |
