...
def test_hand_calculated_lateral_rmse_and_delay():
  telemetry = [
    {"mono_ns": 0, "lateral_error_m": 0.0, "heading_error_rad": 0.0, "speed_mps": 5.0, "op_steering_angle_cmd_deg": 0.0, "simulator_normalized_steer": 0.0, "actual_curvature_1pm": 0.0, "applied_steering_angle_deg": 0.0},
    {"mono_ns": 100_000_000, "lateral_error_m": 0.1, "heading_error_rad": 0.1, "speed_mps": 5.0, "op_steering_angle_cmd_deg": 2.0, "simulator_normalized_steer": 0.1, "actual_curvature_1pm": 0.01, "applied_steering_angle_deg": 1.0},
    {"mono_ns": 200_000_000, "lateral_error_m": -0.1, "heading_error_rad": -0.1, "speed_mps": 5.0, "op_steering_angle_cmd_deg": 4.0, "simulator_normalized_steer": 0.2, "actual_curvature_1pm": 0.02, "applied_steering_angle_deg": 2.0},
    {"mono_ns": 300_000_000, "lateral_error_m": 0.2, "heading_error_rad": 0.2, "speed_mps": 5.0, "op_steering_angle_cmd_deg": 6.0, "simulator_normalized_steer": 0.3, "actual_curvature_1pm": 0.03, "applied_steering_angle_deg": 3.0},
  ]
  ...
  assert result["command_to_applied_steer_gain"] == 0.5
  assert result["command_applied_steer_sign_agreement"] == 1.0
  assert math.isclose(result["actual_curvature_rms_1pm"], math.sqrt(0.00035), rel_tol=1e-9)
